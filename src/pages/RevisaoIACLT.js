...
const s = {
  ...
  msgs: { maxHeight: 240, overflowY: 'auto', border: '0.5px solid rgba(148,163,184,0.14)', borderRadius: 10, padding: 10, marginBottom: 12, display: 'flex', flexDirection: 'column-reverse', gap: 6 },
