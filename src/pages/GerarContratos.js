...
export default function GerarContratos() {
  ...
  return (
    <div>
      ...
      {advogado ? (
        <div style={{ ...s.card, background: proximoLote?.prioridade_fila ? 'rgba(251,191,36,.12)' : 'rgba(96,165,250,.12)', border: proximoLote?.prioridade_fila ? '1.5px solid #fbbf24' : '1.5px solid #185FA540' }}>
